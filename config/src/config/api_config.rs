...
const DEFAULT_MAX_VIEW_GAS: u64 = 2_000_000_000; // We keep this value the same as the max number of gas allowed for one single transaction defined in aptos-gas.
