...
use anyhow::{anyhow, bail, Context as AnyhowContext, Error as AnyhowError, Result};
use aptos_crypto::{
...
impl From<(TransactionInfo, WriteSetPayload, Vec<EventV1>)> for Transaction {
    fn from((info, payload, events): (TransactionInfo, WriteSetPayload, Vec<EventV1>)) -> Self {
