...
pub enum StatusCode {
    ...
    DKG_AGG_SIG_VERIFICATION_FAILED = 60,    // Reserved error code for future use
    RESERVED_VALIDATION_ERROR_10 = 61,
    RESERVED_VALIDATION_ERROR_11 = 62,
    RESERVED_VALIDATION_ERROR_12 = 63,
    RESERVED_VALIDATION_ERROR_13 = 64,
    RESERVED_VALIDATION_ERROR_14 = 65,
    RESERVED_VALIDATION_ERROR_15 = 66,
