spec supra_framework::randomness {
    ...
    spec module {
        ...
        invariant [suspendable] chain_status::is_operating() ==>
            exists<PerBlockRandomness>(@supra_framework);
    ...
    spec on_new_block(
        ...
        ensures exists<PerBlockRandomness>(@supra_framework) ==>
            global<PerBlockRandomness>(@supra_framework).seed == seed_for_new_block;
        ensures exists<PerBlockRandomness>(@supra_framework) ==>
            global<PerBlockRandomness>(@supra_framework).epoch == epoch;
        ensures exists<PerBlockRandomness>(@supra_framework) ==>
            global<PerBlockRandomness>(@supra_framework).round == round;
    }
