...
module supra_framework::vesting_without_staking {
    ...
    public fun setup_vesting_contract_with_schedule(
        ...
        create_vesting_contract(
            admin, buy_ins, vesting_schedule, withdrawal_address, vector[]
        )
    }
    ...
    public entry fun test_termination_after_successful_vesting(
        ...
        let contract_address =
            setup_vesting_contract_with_schedule(
                admin, shareholders, shares, withdrawal_address, &vector[1], 1
            );
        assert!(
    ...
    public entry fun test_vest_individual_early_termination_success(
        ...
        assert!(
            vesting_record_1.last_vested_period == 9, vesting_record_1.last_vested_period
        );
        assert!(
            vesting_record_2.last_vested_period == 9, vesting_record_2.last_vested_period
        );
