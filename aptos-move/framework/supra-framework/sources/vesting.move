...
module supra_framework::vesting {
    ...
    public entry fun test_end_to_end(
        ...
        assert!(
            coin::balance<SupraCoin>(shareholder_1_address)
                == shareholder_1_bal + pending_distribution / 4,
            0
        );
        assert!(
            coin::balance<SupraCoin>(shareholder_2_address)
        ...
        assert!(
            coin::balance<SupraCoin>(withdrawal_address)
    ...
    #[test(
        supra_framework = @0x1, admin = @0x123, shareholder = @0x234, operator = @0x345
    )]
