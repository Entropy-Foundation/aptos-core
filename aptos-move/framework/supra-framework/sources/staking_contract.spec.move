spec supra_framework::staking_contract {
    ...
    spec schema IncreaseLockupWithCapAbortsIf {
        ...
        let seconds = global<timestamp::CurrentTimeMicroseconds>(@supra_framework).microseconds
    ...
    spec schema PreconditionsInCreateContract {
        ...
        requires exists<supra_framework::timestamp::CurrentTimeMicroseconds>(
            @supra_framework
        );
    ...
    spec schema CreateStakePoolAbortsIf {
        ...
        aborts_if exists<stake::AllowedValidators>(@supra_framework)
