...
module supra_framework::staking_contract {
    ...
    #[resource_group_member(
        group = supra_framework::staking_contract::StakingGroupContainer
    )]
    ...
    public entry fun test_end_to_end(
        supra_framework: &signer, staker: &signer, operator: &signer
    ) acquires Store, BeneficiaryForOperator {
    ...
    #[test(
        supra_framework = @0x1, staker = @0x123, operator_1 = @0x234, operator_2 = @0x345
    )]
    ...
    public entry fun test_operator_can_set_beneficiary(
        ...
        assert!(
            coin::balance<SupraCoin>(beneficiary_address) == old_beneficiay_balance, 1
        );
    }
    ...
    public entry fun test_get_expected_stake_pool_address(
        ...
        assert!(
            pool_address
                == @0xb500b8db823e529929e1f9ec79abd731dcc235a2027b28bbb78d65ee928d001a,
            0
        );
    }
