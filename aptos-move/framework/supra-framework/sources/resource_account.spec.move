spec supra_framework::resource_account {
    /// <high-level-req>
    /// No.: 1
    ...
    spec create_resource_account_and_fund(
        ...
        include supra_account::WithdrawAbortsIf<SupraCoin> {
            from: origin,
            amount: fund_amount
        };
        ...
        //coin property
        aborts_if coin::spec_is_account_registered<SupraCoin>(resource_addr)
    ...
    spec rotate_account_authentication_key_and_store_capability(
        ...
        ensures vector::length(optional_auth_key) != 0 ==>
            global<supra_framework::account::Account>(resource_addr).authentication_key
                == optional_auth_key;
    }
