...
module supra_framework::pbo_delegation_pool {
    ...
    public fun initialize_delegation_pool(
        ...
        if (option::is_some<address>(&multisig_admin)) {
            ...
            assert!(
                ms_admin != @0x0, error::invalid_argument(EADMIN_ADDRESS_CANNOT_BE_ZERO)
            );
            assert!(
    ...
    public entry fun replace_delegator(
        ...
        assert!(
            admin_addr != @0x0, error::invalid_argument(EADMIN_ADDRESS_CANNOT_BE_ZERO)
        );
        assert!(
            admin_addr == option::get_with_default(&pool.multisig_admin, @0x0),
        ...
        //replace in `active_shares` pool
        {
            ...
            pool_u64::transfer_shares(
                active_pool, old_delegator, new_delegator, active_shares
            );
        };
    ...
    public entry fun test_add_stake_single(
        ...
        assert!(
            coin::balance<SupraCoin>(validator_address) == balance - 250 * ONE_SUPRA, 0
        );
    ...
    public entry fun test_unlock_single(
        ...
        assert_pending_withdrawal(
            validator_address, pool_address, true, 0, false, 100 * ONE_SUPRA
        );
        ...
        assert_pending_withdrawal(
            validator_address, pool_address, true, 0, false, 50 * ONE_SUPRA
        );
        stake::assert_stake_pool(
            pool_address, 50 * ONE_SUPRA, 0, 200 * ONE_SUPRA, 50 * ONE_SUPRA
        );
        ...
        assert_delegation(validator_address, pool_address, 15403510001, 15301499997, 0);
        stake::assert_stake_pool(
            pool_address, 15403510001, 15301499997, 50 * ONE_SUPRA, 0
        );
        ...
        // the pending withdrawal should be reported as still pending
        assert_pending_withdrawal(
            validator_address, pool_address, true, 2, false, 999999999
        );
        ...
        assert_pending_withdrawal(
            validator_address, pool_address, true, 2, false, 999999998
        );
    ...
    public entry fun test_reactivate_stake_single(
        ...
        stake::assert_stake_pool(
            pool_address, 100 * ONE_SUPRA, 0, 150 * ONE_SUPRA, 100 * ONE_SUPRA
        );
    ...
    public entry fun test_operator_fee(
        ...
        assert_pending_withdrawal(
            validator_address, pool_address, true, 1, false, 12649998
        );
    }
    ...
    fun generate_multisig_account(
        ...
        multisig_account::create_with_owners(
            owner, addition_owner, threshold, vector[], vector[], 300
        );
        multisig_addr
    }
    ...
    public entry fun test_lose_shares_small(
        ...
        assert_delegation(
            delegator1_address, pool_address, 7933617698152064, 0, 100000000
        );
        ...
        assert_delegation(
            delegator1_address, pool_address, 7933617598152064, 0, 199999999
        );
    ...
    public entry fun test_replace_delegation_before_withdraw_and_after_withdraw_success(
        ...
        assert!(
            coin::balance<SupraCoin>(new_delegator_address) == (100 * ONE_SUPRA) - 1, 0
        );
    }
    ...
    public entry fun test_unlocking_before_cliff_period_failure(
        ...
        let unlock_coin =
            can_principle_unlock(
                delegator_address, pool_address, (20 * ONE_SUPRA) - 9
            );
    ...
    public entry fun test_unlocking_principle_stake_success(
        ...
        let unlock_coin =
            can_principle_unlock(
                delegator_address, pool_address, (50 * ONE_SUPRA) - 9
            );
        ...
        let unlock_coin =
            can_principle_unlock(
                delegator_address, pool_address, (60 * ONE_SUPRA) - 9
            );
        ...
        let unlock_coin =
            can_principle_unlock(
                delegator_address, pool_address, (70 * ONE_SUPRA) - 9
            );
        ...
        let unlock_coin =
            can_principle_unlock(
                delegator_address, pool_address, (90 * ONE_SUPRA) - 9
            );
        ...
        let unlock_coin =
            can_principle_unlock(
                delegator_address, pool_address, (100 * ONE_SUPRA) - 10
            );
    ...
    public entry fun test_unlocking_more_principle_stake_after_4_month_failure(
        ...
        let unlock_coin =
            can_principle_unlock(
                delegator_address, pool_address, (20 * ONE_SUPRA) + 1
            );
    ...
    public entry fun test_unlocking_more_principle_stake_after_5_month_failure(
        ...
        let unlock_coin =
            can_principle_unlock(
                delegator_address, pool_address, (50 * ONE_SUPRA) + 1
            );
        assert!(unlock_coin, 20);
    }
    ...
    public entry fun test_unlocking_more_principle_stake_after_6_month_failure(
        ...
        let unlock_coin =
            can_principle_unlock(
                delegator_address, pool_address, (60 * ONE_SUPRA) + 1
            );
        assert!(unlock_coin, 20);
    }
    ...
    public entry fun test_unlocking_more_principle_stake_after_7_month_failure(
        ...
        let unlock_coin =
            can_principle_unlock(
                delegator_address, pool_address, (70 * ONE_SUPRA) + 1
            );
        assert!(unlock_coin, 20);
    }
    ...
    public entry fun test_unlocking_more_principle_stake_after_8_month_failure(
        ...
        let unlock_coin =
            can_principle_unlock(
                delegator_address, pool_address, (80 * ONE_SUPRA) + 1
            );
        assert!(unlock_coin, 20);
    }
    ...
    public entry fun test_unlocking_more_principle_stake_after_9_month_failure(
        ...
        let unlock_coin =
            can_principle_unlock(
                delegator_address, pool_address, (90 * ONE_SUPRA) + 1
            );
        assert!(unlock_coin, 20);
    }
    ...
    public entry fun test_unlocking_more_principle_stake_after_10_month_failure(
        ...
        let unlock_coin =
            can_principle_unlock(
                delegator_address, pool_address, (100 * ONE_SUPRA) + 1
            );
        assert!(unlock_coin, 20);
    }
