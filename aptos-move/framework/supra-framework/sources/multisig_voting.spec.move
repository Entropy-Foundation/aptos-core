spec supra_framework::multisig_voting {
    ...
    // CurrentTimeMicroseconds existed under the @supra_framework.
    ...
    spec vote<ProposalType: store>(
        ...
        aborts_if if (should_pass) { proposal.yes_votes > MAX_U128 } else { proposal.no_votes > MAX_U128 };
        ...
        ensures if (should_pass) {
            post_proposal.yes_votes == proposal.yes_votes + 1
        } else {
            post_proposal.no_votes == proposal.no_votes + 1
        };
