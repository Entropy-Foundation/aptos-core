...
<pre><code><b>public</b> entry <b>fun</b> <a href="stake.md#0x1_stake_initialize_validator">initialize_validator</a>(
    ...
    {
        <b>let</b> valid_public_key = <a href="../../supra-stdlib/doc/consensus_key.md#0x1_consensus_key_consensus_public_key_from_bytes">consensus_key::consensus_public_key_from_bytes</a>(consensus_pubkey);
...
<pre><code><b>fun</b> <a href="stake.md#0x1_stake_rotate_consensus_key_internal">rotate_consensus_key_internal</a>(
    ...
    // Checks the <b>public</b> key is valid <b>to</b> prevent rogue-key attacks.
    {
        <b>let</b> validated_public_key = <a href="../../supra-stdlib/doc/consensus_key.md#0x1_consensus_key_consensus_public_key_from_bytes">consensus_key::consensus_public_key_from_bytes</a>(new_consensus_pubkey);
