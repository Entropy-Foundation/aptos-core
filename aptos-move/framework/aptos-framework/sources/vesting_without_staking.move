...
// last vesting fraction must be non zero to ensure that no amount remains unvested forever.
    ...
    fun distribute(vesting_fraction: FixedPoint32, contract_address: address) acquires VestingContract {
        ...
        // spec {
        //     update ghost_address_num = len(shareholders_address);
        //     update ghost_records_num = len(vesting_records);
        // };
        while (
            // {
            // spec {
        ...
        )
         {
            ...
            // spec {
            //     update ghost_address_num = ghost_address_num - 1;
            //     update ghost_records_num = ghost_records_num - 1;
            // };
        };
